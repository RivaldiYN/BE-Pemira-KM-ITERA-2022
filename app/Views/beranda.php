...
<head>
    ...
    <link rel="preload" as="image" href="<?php echo base_url('/images/bg-beranda.svg') ?>">
    <link rel="preload" as="image" href="<?php echo base_url('/images/logo_2.svg') ?>">
    <link rel="preload" as="image" href="<?php echo base_url('/images/awan.svg') ?>">
    ...
    ">
        <div class="maincontainer relative top-9 md:top-64">
            <h1 class="text-normal-desktop md:text-extra-desktop  text-center font-bold leading-relaxed py-4 md:py-8 text">
                Tentang Pemira </h1>
            <div
                class="container border-4 md:border-8 border-button-color rounded-normal-desktop shadow-[#bababa] shadow-md md:p-10 md:w-[70vw]  md:mx-auto p-4 text-normal-mobile md:text-normal-desktop">
